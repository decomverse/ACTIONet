...
aggregate_genesets_weighted_enrichment <- function(G, S, marker_mat, network_normalization_method = 0L, expression_normalization_method = 0L, gene_scaling_method = 3L, pre_alpha = 0.85, post_alpha = 0.85, thread_no = 0L) {
    .Call(`_ACTIONet_aggregate_genesets_weighted_enrichment`, G, S, marker_mat, network_normalization_method, expression_normalization_method, gene_scaling_method, pre_alpha, post_alpha, thread_no)
}
