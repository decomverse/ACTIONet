...
reduce_kernel <- function(S, reduced_dim = 50L, iter = 5L, seed = 0L, SVD_algorithm = 0L, 
    prenormalize = FALSE) {
...
#' reduction.out = reduce(S, reduced_dim = 50)
#' S_r = reduction.out$S_r
reduce_kernel_full <- function(S, reduced_dim = 50L, iter = 5L, seed = 0L, SVD_algorithm = 0L, 
    prenormalize = FALSE) {
    .Call(`_ACTIONet_reduce_kernel_full`, S, reduced_dim, iter, seed, SVD_algorithm, 
        prenormalize)
}
...
run_ACTION <- function(S_r, k_min = 2L, k_max = 30L, thread_no = 0L, max_it = 50L, 
    min_delta = 1e-16) {
    .Call(`_ACTIONet_run_ACTION`, S_r, k_min, k_max, thread_no, max_it, min_delta)
}

run_ACTION_plus <- function(S_r, k_min = 2L, k_max = 30L, max_it = 50L, min_delta = 1e-16, 
    max_trial = 3L) {
...
run_weighted_ACTION <- function(S_r, w, k_min = 2L, k_max = 30L, thread_no = 0L, 
    max_it = 50L, min_delta = 1e-16) {
    .Call(`_ACTIONet_run_weighted_ACTION`, S_r, w, k_min, k_max, thread_no, max_it, 
        min_delta)
}
...
unify_archetypes <- function(G, S_r, C_stacked, alpha = 0.99, sensitivity = 0, thread_no = 0L) {
...
#' prune.out = prune_archetypes(ACTION.out$C, ACTION.out$H)
#'\tG = build_ACTIONet(prune.out$H_stacked)
build_ACTIONet <- function(H_stacked, density = 1, thread_no = 0L, mutual_edges_only = TRUE) {
...
layout_ACTIONet <- function(G, S_r, compactness_level = 50L, n_epochs = 500L, layout_alg = 0L, 
    thread_no = 0L, seed = 0L) {
    .Call(`_ACTIONet_layout_ACTIONet`, G, S_r, compactness_level, n_epochs, layout_alg, 
        thread_no, seed)
}
...
compute_sparse_network_diffusion <- function(G, X0, alpha = 0.85, rho = 1e-04, epsilon = 0.001, 
    max_iter = 20L) {
    .Call(`_ACTIONet_compute_sparse_network_diffusion`, G, X0, alpha, rho, epsilon, 
        max_iter)
}
...
signed_cluster <- function(A, resolution_parameter = 1, initial_clusters_ = NULL, 
    seed = 0L) {
    .Call(`_ACTIONet_signed_cluster`, A, resolution_parameter, initial_clusters_, 
        seed)
}

unsigned_cluster_batch <- function(A, resolutions, initial_clusters_ = NULL, seed = 0L) {
    .Call(`_ACTIONet_unsigned_cluster_batch`, A, resolutions, initial_clusters_, 
        seed)
}
...
unsigned_cluster <- function(A, resolution_parameter = 1, initial_clusters_ = NULL, 
    seed = 0L) {
    .Call(`_ACTIONet_unsigned_cluster`, A, resolution_parameter, initial_clusters_, 
        seed)
}

Prune_PageRank <- function(U, density = 1) {
    .Call(`_ACTIONet_Prune_PageRank`, U, density)
}

transform_layout <- function(W, coor2D, coor3D, colRGB, compactness_level = 50L, 
    n_epochs = 500L, thread_no = 0L, seed = 0L) {
    .Call(`_ACTIONet_transform_layout`, W, coor2D, coor3D, colRGB, compactness_level, 
        n_epochs, thread_no, seed)
}

sgd2_layout_weighted <- function(G, S_r, t_max = 30L, eps = 0.01, seed = 0L) {
    .Call(`_ACTIONet_sgd2_layout_weighted`, G, S_r, t_max, eps, seed)
}

sgd2_layout_weighted_convergent <- function(G, S_r, t_max = 30L, eps = 0.01, delta = 0.03, 
    t_maxmax = 200L, seed = 0L) {
    .Call(`_ACTIONet_sgd2_layout_weighted_convergent`, G, S_r, t_max, eps, delta, 
        t_maxmax, seed)
}

sgd2_layout_sparse_weighted <- function(G, S_r, p = 200L, t_max = 30L, eps = 0.01, 
    seed = 0L) {
...
run_subACTION <- function(S_r, W_parent, H_parent, kk, k_min, k_max, thread_no, max_it = 50L, 
    min_delta = 1e-16) {
    .Call(`_ACTIONet_run_subACTION`, S_r, W_parent, H_parent, kk, k_min, k_max, thread_no, 
        max_it, min_delta)
}

deflate_reduction <- function(old_S_r, old_V, old_A, old_B, old_sigma, A, B) {
    .Call(`_ACTIONet_deflate_reduction`, old_S_r, old_V, old_A, old_B, old_sigma, 
        A, B)
}

orthogonalize_batch_effect <- function(S, old_S_r, old_V, old_A, old_B, old_sigma, 
    design) {
    .Call(`_ACTIONet_orthogonalize_batch_effect`, S, old_S_r, old_V, old_A, old_B, 
        old_sigma, design)
}

orthogonalize_batch_effect_full <- function(S, old_S_r, old_V, old_A, old_B, old_sigma, 
    design) {
    .Call(`_ACTIONet_orthogonalize_batch_effect_full`, S, old_S_r, old_V, old_A, 
        old_B, old_sigma, design)
}
...
compute_marker_aggregate_stats <- function(G, S, marker_mat, alpha = 0.85, max_it = 5L, 
    thread_no = 0L) {
    .Call(`_ACTIONet_compute_marker_aggregate_stats`, G, S, marker_mat, alpha, max_it, 
        thread_no)
}
