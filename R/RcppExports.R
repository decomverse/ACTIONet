...
unify_archetypes <- function(S_r, C_stacked, H_stacked, min_overlap = 10, resolution = 1) {
...
compute_sparse_network_diffusion <- function(G, X0, alpha = 0.85, rho = 1e-04, epsilon = 0.001, max_iter = 20L) {
...
signed_cluster <- function(A, resolution_parameter = 1, initial_clusters_ = NULL, seed = 0L) {
...
unsigned_cluster <- function(A, resolution_parameter = 1, initial_clusters_ = NULL, seed = 0L) {
