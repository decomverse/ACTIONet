...
unify_archetypes <- function(G, S_r, C_stacked, alpha = 0.99, outlier_threshold = 0, 
    sim_threshold = 0, thread_no = 0L) {
    .Call(`_ACTIONet_unify_archetypes`, G, S_r, C_stacked, alpha, outlier_threshold, 
        sim_threshold, thread_no)
}
