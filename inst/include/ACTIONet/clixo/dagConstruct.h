...
*/
  ...
  inline vector<pair<double, unsigned>>::iterator
  historicalWeightsBegin(unsigned long id) {
    return currentClusters[id].historicalWeightsBegin();
  }

  inline vector<pair<double, unsigned>>::iterator
  historicalWeightsEnd(unsigned long id) {
...
inline bool
checkClusterValidity(const boost::dynamic_bitset<unsigned long> &cluster,
                     nodeDistanceObject &nodeDistances,
                     vector<vector<bool>> &pairLCAFound) {
  bool firstPairFound = false;
  double firstPairDistance;
...
inline bool
isClusterMaximal(vector<boost::dynamic_bitset<unsigned long>>::reverse_iterator
                     &clustersToAddIt,
...
/*inline*/ unsigned
checkForDelete(currentClusterClassBitset &currentClusters, unsigned otherNode,
               unsigned nodeToUse,
...
////////////////////////////////////////////////////////////////////////
unsigned
getFuzzyClustersBitsetThreshold(nodeDistanceObject &nodeDistances,
                                map<string, unsigned> &nodeNamesToIDs,
                                vector<validClusterBitset> &validClusters,
                                double threshold = 0, double density = 1) {
  time_t start, end;
  time(&start);
