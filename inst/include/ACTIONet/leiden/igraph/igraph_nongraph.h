...
DECLDIR int igraph_running_mean(const igraph_vector_t *data,
                                igraph_vector_t *res,
                                igraph_integer_t binwidth);
DECLDIR int igraph_fisher_yates_shuffle(igraph_vector_t *seq);
DECLDIR int igraph_random_sample(igraph_vector_t *res, igraph_real_t l,
                                 igraph_real_t h, igraph_integer_t length);
DECLDIR int igraph_convex_hull(const igraph_matrix_t *data,
...
DECLDIR int igraph_zeroin(igraph_real_t *ax, igraph_real_t *bx,
                          ...
                          void *info, igraph_real_t *Tol, int *Maxit,
                          igraph_real_t *res);
DECLDIR int igraph_bfgs(igraph_vector_t *b, igraph_real_t *Fmin,
                        igraph_scalar_function_t fminfn,
                        igraph_vector_function_t fmingr, int maxit, int trace,
                        igraph_real_t abstol, igraph_real_t reltol, int nREPORT,
                        void *ex, igraph_integer_t *fncount,
                        igraph_integer_t *grcount);
DECLDIR int igraph_power_law_fit(const igraph_vector_t *vector,
