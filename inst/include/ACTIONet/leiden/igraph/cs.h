...
UF_long cs_dl_fkeep(cs_dl *A,
                    UF_long (*fkeep)(UF_long, UF_long, double, void *),
                    void *other);
...
UF_long cs_dl_leaf(UF_long i, UF_long j, const UF_long *first,
                   UF_long *maxfirst, UF_long *prevleaf, UF_long *ancestor,
                   UF_long *jleaf);
...
int cs_ci_spsolve(cs_ci *L, const cs_ci *B, int k, int *xi, cs_complex_t *x,
                  const int *pinv, int lo);
...
UF_long cs_cl_lusol(UF_long order, const cs_cl *A, cs_complex_t *b, double tol);
...
UF_long cs_cl_ipvec(const UF_long *p, const cs_complex_t *b, cs_complex_t *x,
                    UF_long n);
...
UF_long cs_cl_pvec(const UF_long *p, const cs_complex_t *b, cs_complex_t *x,
                   UF_long n);
...
UF_long cs_cl_fkeep(cs_cl *A,
                    UF_long (*fkeep)(UF_long, UF_long, cs_complex_t, void *),
                    void *other);
...
UF_long cs_cl_scatter(const cs_cl *A, UF_long j, cs_complex_t beta, UF_long *w,
                      cs_complex_t *x, UF_long mark, cs_cl *C, UF_long nz);
