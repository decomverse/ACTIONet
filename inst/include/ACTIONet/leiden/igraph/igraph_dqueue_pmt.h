...
DECLDIR int FUNCTION(igraph_dqueue, init)(TYPE(igraph_dqueue) * q,
                                          long int size);
DECLDIR void FUNCTION(igraph_dqueue, destroy)(TYPE(igraph_dqueue) * q);
DECLDIR igraph_bool_t FUNCTION(igraph_dqueue,
                               empty)(const TYPE(igraph_dqueue) * q);
...
DECLDIR BASE FUNCTION(igraph_dqueue, e)(const TYPE(igraph_dqueue) * q,
                                        long int idx);
