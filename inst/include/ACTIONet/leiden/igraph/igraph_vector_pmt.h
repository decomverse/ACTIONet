...
DECLDIR int FUNCTION(igraph_vector, init)(TYPE(igraph_vector) * v,
                                          long int size);
DECLDIR int FUNCTION(igraph_vector, init_copy)(TYPE(igraph_vector) * v,
                                               const BASE *data,
                                               long int length);
DECLDIR int FUNCTION(igraph_vector, init_seq)(TYPE(igraph_vector) * v,
                                              BASE from, BASE to);
...
DECLDIR long int FUNCTION(igraph_vector,
                          capacity)(const TYPE(igraph_vector) * v);
...
DECLDIR BASE FUNCTION(igraph_vector, e)(const TYPE(igraph_vector) * v,
                                        long int pos);
BASE *FUNCTION(igraph_vector, e_ptr)(const TYPE(igraph_vector) * v,
                                     long int pos);
DECLDIR void FUNCTION(igraph_vector, set)(TYPE(igraph_vector) * v, long int pos,
                                          BASE value);
...
DECLDIR const TYPE(igraph_vector) *
    FUNCTION(igraph_vector, view)(const TYPE(igraph_vector) * v,
...
DECLDIR void FUNCTION(igraph_vector, copy_to)(const TYPE(igraph_vector) * v,
                                              BASE *to);
...
DECLDIR int FUNCTION(igraph_vector, append)(TYPE(igraph_vector) * to,
                                            const TYPE(igraph_vector) * from);
DECLDIR int FUNCTION(igraph_vector, swap)(TYPE(igraph_vector) * v1,
...
DECLDIR void FUNCTION(igraph_vector, add_constant)(TYPE(igraph_vector) * v,
                                                   BASE plus);
...
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               all_e)(const TYPE(igraph_vector) * lhs,
                                      const TYPE(igraph_vector) * rhs);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               all_l)(const TYPE(igraph_vector) * lhs,
                                      const TYPE(igraph_vector) * rhs);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               all_g)(const TYPE(igraph_vector) * lhs,
                                      const TYPE(igraph_vector) * rhs);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               all_le)(const TYPE(igraph_vector) * lhs,
                                       const TYPE(igraph_vector) * rhs);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               all_ge)(const TYPE(igraph_vector) * lhs,
                                       const TYPE(igraph_vector) * rhs);
...
DECLDIR long int FUNCTION(igraph_vector,
                          which_min)(const TYPE(igraph_vector) * v);
DECLDIR long int FUNCTION(igraph_vector,
                          which_max)(const TYPE(igraph_vector) * v);
...
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               empty)(const TYPE(igraph_vector) * v);
DECLDIR long int FUNCTION(igraph_vector, size)(const TYPE(igraph_vector) * v);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               isnull)(const TYPE(igraph_vector) * v);
DECLDIR BASE FUNCTION(igraph_vector, sum)(const TYPE(igraph_vector) * v);
DECLDIR igraph_real_t FUNCTION(igraph_vector,
                               sumsq)(const TYPE(igraph_vector) * v);
DECLDIR BASE FUNCTION(igraph_vector, prod)(const TYPE(igraph_vector) * v);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               isininterval)(const TYPE(igraph_vector) * v,
                                             BASE low, BASE high);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               any_smaller)(const TYPE(igraph_vector) * v,
                                            BASE limit);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               is_equal)(const TYPE(igraph_vector) * lhs,
                                         const TYPE(igraph_vector) * rhs);
DECLDIR igraph_real_t FUNCTION(igraph_vector,
                               maxdifference)(const TYPE(igraph_vector) * m1,
...
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               contains)(const TYPE(igraph_vector) * v, BASE e);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               search)(const TYPE(igraph_vector) * v,
                                       long int from, BASE what, long int *pos);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               binsearch)(const TYPE(igraph_vector) * v,
                                          BASE what, long int *pos);
DECLDIR igraph_bool_t FUNCTION(igraph_vector,
                               binsearch2)(const TYPE(igraph_vector) * v,
                                           BASE what);
...
DECLDIR int FUNCTION(igraph_vector, resize)(TYPE(igraph_vector) * v,
                                            long int newsize);
DECLDIR int FUNCTION(igraph_vector, resize_min)(TYPE(igraph_vector) * v);
DECLDIR int FUNCTION(igraph_vector, reserve)(TYPE(igraph_vector) * v,
                                             long int size);
...
DECLDIR int FUNCTION(igraph_vector, insert)(TYPE(igraph_vector) * v,
                                            long int pos, BASE value);
DECLDIR void FUNCTION(igraph_vector, remove)(TYPE(igraph_vector) * v,
                                             long int elem);
