...
DECLDIR int igraph_adjlist_init_empty(igraph_adjlist_t *al,
...
DECLDIR igraph_bool_t igraph_adjlist_has_edge(igraph_adjlist_t *al,
                                              igraph_integer_t from,
                                              igraph_integer_t to,
                                              igraph_bool_t directed);
DECLDIR int igraph_adjlist_replace_edge(igraph_adjlist_t *al,
                                        igraph_integer_t from,
...
DECLDIR int igraph_inclist_init(const igraph_t *graph, igraph_inclist_t *il,
                                igraph_neimode_t mode);
...
DECLDIR int igraph_adjedgelist_init(const igraph_t *graph, igraph_inclist_t *il,
                                    igraph_neimode_t mode);
...
#define igraph_lazy_adjedgelist_get(al, no)                                    \
  ((al)->incs[(long int)(no)] != 0                                             \
       ? ((al)->incs[(long int)(no)])                                          \
       : (igraph_lazy_adjedgelist_get_real(al, no)))
DECLDIR igraph_vector_t *
igraph_lazy_adjedgelist_get_real(igraph_lazy_inclist_t *al,
                                 igraph_integer_t no);
__END_DECLS
