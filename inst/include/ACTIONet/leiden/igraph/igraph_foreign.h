...
DECLDIR int igraph_read_graph_graphml(igraph_t *graph, FILE *instream,
                                      int index);
DECLDIR int
igraph_read_graph_dimacs(igraph_t *graph, FILE *instream,
                         igraph_strvector_t *problem, igraph_vector_t *label,
                         igraph_integer_t *source, igraph_integer_t *target,
                         igraph_vector_t *capacity, igraph_bool_t directed);
