...
DECLDIR long int FUNCTION(igraph_matrix,
                          capacity)(const TYPE(igraph_matrix) * m);
...
BASE *FUNCTION(igraph_matrix, e_ptr)(const TYPE(igraph_matrix) * m,
                                     long int row, long int col);
DECLDIR void FUNCTION(igraph_matrix, set)(TYPE(igraph_matrix) * m, long int row,
                                          long int col, BASE value);
...
const TYPE(igraph_matrix) *
    FUNCTION(igraph_matrix, view)(const TYPE(igraph_matrix) * m,
                                  const BASE *data, long int nrow,
                                  long int ncol);
...
DECLDIR void FUNCTION(igraph_matrix, copy_to)(const TYPE(igraph_matrix) * m,
                                              BASE *to);
...
DECLDIR int FUNCTION(igraph_matrix, cbind)(TYPE(igraph_matrix) * to,
                                           const TYPE(igraph_matrix) * from);
DECLDIR int FUNCTION(igraph_matrix, swap)(TYPE(igraph_matrix) * m1,
                                          TYPE(igraph_matrix) * m2);
...
DECLDIR int FUNCTION(igraph_matrix,
                     select_rows_cols)(const TYPE(igraph_matrix) * m,
                                       TYPE(igraph_matrix) * res,
                                       const igraph_vector_t *rows,
                                       const igraph_vector_t *cols);
...
DECLDIR int FUNCTION(igraph_matrix, sub)(TYPE(igraph_matrix) * m1,
                                         const TYPE(igraph_matrix) * m2);
DECLDIR int FUNCTION(igraph_matrix,
                     mul_elements)(TYPE(igraph_matrix) * m1,
                                   const TYPE(igraph_matrix) * m2);
DECLDIR int FUNCTION(igraph_matrix,
                     div_elements)(TYPE(igraph_matrix) * m1,
                                   const TYPE(igraph_matrix) * m2);
DECLDIR void FUNCTION(igraph_matrix, scale)(TYPE(igraph_matrix) * m, BASE by);
DECLDIR void FUNCTION(igraph_matrix, add_constant)(TYPE(igraph_matrix) * m,
                                                   BASE plus);
...
DECLDIR igraph_real_t FUNCTION(igraph_matrix,
                               min)(const TYPE(igraph_matrix) * m);
DECLDIR igraph_real_t FUNCTION(igraph_matrix,
                               max)(const TYPE(igraph_matrix) * m);
...
DECLDIR int FUNCTION(igraph_matrix, minmax)(const TYPE(igraph_matrix) * m,
                                            BASE *min, BASE *max);
DECLDIR int FUNCTION(igraph_matrix,
                     which_minmax)(const TYPE(igraph_matrix) * m,
...
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               all_e)(const TYPE(igraph_matrix) * lhs,
                                      const TYPE(igraph_matrix) * rhs);
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               all_l)(const TYPE(igraph_matrix) * lhs,
                                      const TYPE(igraph_matrix) * rhs);
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               all_g)(const TYPE(igraph_matrix) * lhs,
                                      const TYPE(igraph_matrix) * rhs);
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               all_le)(const TYPE(igraph_matrix) * lhs,
                                       const TYPE(igraph_matrix) * rhs);
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               all_ge)(const TYPE(igraph_matrix) * lhs,
                                       const TYPE(igraph_matrix) * rhs);
...
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               isnull)(const TYPE(igraph_matrix) * m);
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               empty)(const TYPE(igraph_matrix) * m);
...
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               is_symmetric)(const TYPE(igraph_matrix) * m);
...
DECLDIR int FUNCTION(igraph_matrix, colsum)(const TYPE(igraph_matrix) * m,
                                            TYPE(igraph_vector) * res);
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               is_equal)(const TYPE(igraph_matrix) * m1,
                                         const TYPE(igraph_matrix) * m2);
DECLDIR igraph_real_t FUNCTION(igraph_matrix,
                               maxdifference)(const TYPE(igraph_matrix) * m1,
                                              const TYPE(igraph_matrix) * m2);
...
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               contains)(const TYPE(igraph_matrix) * m, BASE e);
DECLDIR igraph_bool_t FUNCTION(igraph_matrix,
                               search)(const TYPE(igraph_matrix) * m,
...
DECLDIR int FUNCTION(igraph_matrix, add_cols)(TYPE(igraph_matrix) * m,
                                              long int n);
DECLDIR int FUNCTION(igraph_matrix, add_rows)(TYPE(igraph_matrix) * m,
                                              long int n);
DECLDIR int FUNCTION(igraph_matrix, remove_col)(TYPE(igraph_matrix) * m,
                                                long int col);
DECLDIR int FUNCTION(igraph_matrix, remove_row)(TYPE(igraph_matrix) * m,
                                                long int row);
...
int FUNCTION(igraph_matrix, printf)(const TYPE(igraph_matrix) * m,
                                    const char *format);
int FUNCTION(igraph_matrix, fprint)(const TYPE(igraph_matrix) * m, FILE *file);
