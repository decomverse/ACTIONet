...
/**
 * \section about_igraph_spmatrix_t_objects About \type igraph_spmatrix_t
 * objects
 *
...
#define IGRAPH_SPMATRIX_INIT_FINALLY(m, nr, nc)                                \
  do {                                                                         \
    IGRAPH_CHECK(igraph_spmatrix_init(m, nr, nc));                             \
    IGRAPH_FINALLY(igraph_spmatrix_destroy, m);                                \
  } while (0)

DECLDIR int igraph_spmatrix_init(igraph_spmatrix_t *m, long int nrow,
                                 long int ncol);
DECLDIR void igraph_spmatrix_destroy(igraph_spmatrix_t *m);
DECLDIR int igraph_spmatrix_resize(igraph_spmatrix_t *m, long int nrow,
                                   long int ncol);
DECLDIR igraph_real_t igraph_spmatrix_e(const igraph_spmatrix_t *m,
                                        long int row, long int col);
DECLDIR int igraph_spmatrix_set(igraph_spmatrix_t *m, long int row,
                                long int col, igraph_real_t value);
DECLDIR int igraph_spmatrix_add_e(igraph_spmatrix_t *m, long int row,
                                  long int col, igraph_real_t value);
DECLDIR int igraph_spmatrix_add_col_values(igraph_spmatrix_t *m, long int to,
                                           long int from);
...
DECLDIR int igraph_spmatrix_copy_to(const igraph_spmatrix_t *m,
                                    igraph_real_t *to);
...
DECLDIR int igraph_spmatrix_copy(igraph_spmatrix_t *to,
                                 const igraph_spmatrix_t *from);
...
DECLDIR int igraph_spmatrix_colsums(const igraph_spmatrix_t *m,
                                    igraph_vector_t *res);
DECLDIR int igraph_spmatrix_rowsums(const igraph_spmatrix_t *m,
                                    igraph_vector_t *res);
...
DECLDIR int
igraph_i_spmatrix_get_col_nonzero_indices(const igraph_spmatrix_t *m,
                                          igraph_vector_t *res, long int col);
DECLDIR int igraph_i_spmatrix_clear_row_fast(igraph_spmatrix_t *m,
                                             long int row);
...
DECLDIR int igraph_spmatrix_iter_create(igraph_spmatrix_iter_t *mit,
