 ...
 *
 * \enumval IGRAPH_COLORING_GREEDY_COLORED_NEIGHBORS  Choose vertex with largest
 * number of already colored neighbors.
 *
 */
typedef enum {
...
DECLDIR int igraph_vertex_coloring_greedy(const igraph_t *graph,
                                          igraph_vector_int_t *colors,
                                          igraph_coloring_greedy_t heuristic);
