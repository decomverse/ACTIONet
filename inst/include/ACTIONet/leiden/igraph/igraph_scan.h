...
DECLDIR int igraph_local_scan_1_ecount(const igraph_t *graph,
                                       igraph_vector_t *res,
                                       const igraph_vector_t *weights,
                                       igraph_neimode_t mode);

DECLDIR int igraph_local_scan_1_ecount_them(const igraph_t *us,
                                            const igraph_t *them,
                                            igraph_vector_t *res,
                                            const igraph_vector_t *weights,
                                            igraph_neimode_t mode);
...
DECLDIR int igraph_local_scan_k_ecount_them(const igraph_t *us,
                                            const igraph_t *them, int k,
                                            igraph_vector_t *res,
                                            const igraph_vector_t *weights_them,
                                            igraph_neimode_t mode);

DECLDIR int igraph_local_scan_neighborhood_ecount(
