...
DECLDIR long int igraph_rng_get_integer(igraph_rng_t *rng, long int l,
                                        long int h);
DECLDIR igraph_real_t igraph_rng_get_normal(igraph_rng_t *rng, igraph_real_t m,
                                            igraph_real_t s);
DECLDIR igraph_real_t igraph_rng_get_unif(igraph_rng_t *rng, igraph_real_t l,
                                          igraph_real_t h);
...
DECLDIR igraph_real_t igraph_rng_get_gamma(igraph_rng_t *rng,
                                           igraph_real_t shape,
                                           igraph_real_t scale);
...
#define RNG_INTEGER(l, h)                                                      \
  (igraph_rng_get_integer(igraph_rng_default(), (l), (h)))
