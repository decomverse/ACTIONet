...
DECLDIR int igraph_are_connected(const igraph_t *graph, igraph_integer_t v1,
                                 igraph_integer_t v2, igraph_bool_t *res);

/* -------------------------------------------------- */
/* Structural properties                              */
/* -------------------------------------------------- */

DECLDIR int igraph_minimum_spanning_tree(const igraph_t *graph,
                                         igraph_vector_t *res,
                                         const igraph_vector_t *weights);
DECLDIR int igraph_minimum_spanning_tree_unweighted(const igraph_t *graph,
                                                    igraph_t *mst);
DECLDIR int igraph_minimum_spanning_tree_prim(const igraph_t *graph,
                                              igraph_t *mst,
                                              const igraph_vector_t *weights);
DECLDIR int igraph_random_spanning_tree(const igraph_t *graph,
                                        igraph_vector_t *res,
                                        igraph_integer_t vid);

DECLDIR int igraph_subcomponent(const igraph_t *graph, igraph_vector_t *res,
                                igraph_real_t vid, igraph_neimode_t mode);
DECLDIR int igraph_rewire(igraph_t *graph, igraph_integer_t n,
...
DECLDIR int igraph_is_multiple(const igraph_t *graph, igraph_vector_bool_t *res,
                               igraph_es_t es);
DECLDIR int igraph_count_multiple(const igraph_t *graph, igraph_vector_t *res,
                                  igraph_es_t es);
DECLDIR int igraph_is_tree(const igraph_t *graph, igraph_bool_t *res,
                           igraph_integer_t *root, igraph_neimode_t mode);
DECLDIR int igraph_girth(const igraph_t *graph, igraph_integer_t *girth,
                         igraph_vector_t *circle);
DECLDIR int igraph_add_edge(igraph_t *graph, igraph_integer_t from,
                            igraph_integer_t to);
...
DECLDIR int igraph_is_mutual(igraph_t *graph, igraph_vector_bool_t *res,
                             igraph_es_t es);
...
DECLDIR int igraph_is_chordal(const igraph_t *graph,
                              ...
                              igraph_bool_t *chordal, igraph_vector_t *fill_in,
                              igraph_t *newgraph);
DECLDIR int igraph_avg_nearest_neighbor_degree(
...
DECLDIR int
igraph_contract_vertices(igraph_t *graph, const igraph_vector_t *mapping,
                         const igraph_attribute_combination_t *vertex_comb);

DECLDIR int igraph_feedback_arc_set(const igraph_t *graph,
...
int igraph_i_feedback_arc_set_undirected(const igraph_t *graph,
                                         igraph_vector_t *result,
                                         const igraph_vector_t *weights,
                                         igraph_vector_t *layering);
int igraph_i_feedback_arc_set_eades(const igraph_t *graph,
                                    igraph_vector_t *result,
                                    const igraph_vector_t *weights,
                                    igraph_vector_t *layering);
