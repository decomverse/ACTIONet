...
DECLDIR int igraph_create(igraph_t *graph, const igraph_vector_t *edges,
                          igraph_integer_t n, igraph_bool_t directed);
DECLDIR int igraph_small(igraph_t *graph, igraph_integer_t n,
                         igraph_bool_t directed, ...);
DECLDIR int igraph_adjacency(igraph_t *graph, igraph_matrix_t *adjmatrix,
                             igraph_adjacency_t mode);
DECLDIR int igraph_weighted_adjacency(igraph_t *graph,
                                      igraph_matrix_t *adjmatrix,
                                      igraph_adjacency_t mode, const char *attr,
                                      igraph_bool_t loops);
DECLDIR int igraph_star(igraph_t *graph, igraph_integer_t n,
                        igraph_star_mode_t mode, igraph_integer_t center);
DECLDIR int igraph_lattice(igraph_t *graph, const igraph_vector_t *dimvector,
                           igraph_integer_t nei, igraph_bool_t directed,
                           igraph_bool_t mutual, igraph_bool_t circular);
DECLDIR int igraph_ring(igraph_t *graph, igraph_integer_t n,
                        igraph_bool_t directed, igraph_bool_t mutual,
                        igraph_bool_t circular);
DECLDIR int igraph_tree(igraph_t *graph, igraph_integer_t n,
                        igraph_integer_t children, igraph_tree_mode_t type);
DECLDIR int igraph_from_prufer(igraph_t *graph,
                               const igraph_vector_int_t *prufer);
DECLDIR int igraph_full(igraph_t *graph, igraph_integer_t n,
...
DECLDIR int igraph_extended_chordal_ring(igraph_t *graph,
...
DECLDIR int igraph_de_bruijn(igraph_t *graph, igraph_integer_t m,
                             igraph_integer_t n);
DECLDIR int igraph_kautz(igraph_t *graph, igraph_integer_t m,
                         igraph_integer_t n);
