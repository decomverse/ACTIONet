...
```{r}
ACTION.out = run_ACTION(S_r, k_max = 30, thread_no =8, max_it = 50, min_delta = 0.01, type = 1)
...
```{r}
	unification.out = unify_archetypes(G, S_r, C_stacked, H_stacked, minPoints = 10, minClusterSize = 10, outlier_threshold = 0.5)
