...
```{r}
	unification.out = unify_archetypes(G, S_r, pruning.out$C_stacked, pruning.out$H_stacked, minPoints = 10, minClusterSize = 10, outlier_threshold = 0.5)
...
```{r}
	...
	ace$assigned_archetype = unification.out$sample_assignments
