...
ModularityVertexPartition::create(Graph *graph,
...
#ifdef DEBUG
  cerr << "double ModularityVertexPartition::diff_move(" << v << ", "
       << new_comm << ")" << endl;
#endif
...
#endif
    double diff_new =
        (w_to_new + self_weight - k_out * K_in_new / total_weight) +
...
#ifdef DEBUG
  cerr << "exit double ModularityVertexPartition::diff_move((" << v << ", "
       << new_comm << ")" << endl;
