...
int igraph_i_cattributes_copy_attribute_record(
    igraph_attribute_record_t **newrec, const igraph_attribute_record_t *rec) {
...
int igraph_i_cattribute_init(igraph_t *graph, igraph_vector_ptr_t *attr) {
  ...
  for (i = 0; i < n; i++) {
    IGRAPH_CHECK(igraph_i_cattributes_copy_attribute_record(&attr_rec,
                                                            VECTOR(*attr)[i]));
...
int igraph_i_cattribute_copy(igraph_t *to, const igraph_t *from,
  ...
  igraph_vector_ptr_t *alto[3],
      *alfrom[3] = {&attrfrom->gal, &attrfrom->val, &attrfrom->eal};
  long int i, n, a;
...
int igraph_i_cattribute_combine_vertices(
  ...
  for (i = 0, j = 0; i < valno; i++) {
    ...
    if (type == IGRAPH_ATTRIBUTE_NUMERIC) {
      ...
      case IGRAPH_ATTRIBUTE_COMBINE_FUNCTION:
        IGRAPH_CHECK(
            igraph_i_cattributes_cn_func(oldrec, newrec, merges, numfunc));
        break;
      ...
      case IGRAPH_ATTRIBUTE_COMBINE_CONCAT:
        ...
        break;
      default:
        IGRAPH_ERROR("Unknown attribute_combination", IGRAPH_UNIMPLEMENTED);
        break;
      }
    } else if (type == IGRAPH_ATTRIBUTE_BOOLEAN) {
      switch (todo) {
      case IGRAPH_ATTRIBUTE_COMBINE_FUNCTION:
        IGRAPH_CHECK(
            igraph_i_cattributes_cb_func(oldrec, newrec, merges, boolfunc));
        break;
      case IGRAPH_ATTRIBUTE_COMBINE_SUM:
      case IGRAPH_ATTRIBUTE_COMBINE_MAX:
        IGRAPH_CHECK(
            igraph_i_cattributes_cb_any_is_true(oldrec, newrec, merges));
        break;
      case IGRAPH_ATTRIBUTE_COMBINE_PROD:
      case IGRAPH_ATTRIBUTE_COMBINE_MIN:
        IGRAPH_CHECK(
            igraph_i_cattributes_cb_all_is_true(oldrec, newrec, merges));
        break;
      case IGRAPH_ATTRIBUTE_COMBINE_MEAN:
      case IGRAPH_ATTRIBUTE_COMBINE_MEDIAN:
      ...
      case IGRAPH_ATTRIBUTE_COMBINE_FUNCTION:
        IGRAPH_CHECK(
            igraph_i_cattributes_sn_func(oldrec, newrec, merges, strfunc));
        break;
      case IGRAPH_ATTRIBUTE_COMBINE_SUM:
      ...
      case IGRAPH_ATTRIBUTE_COMBINE_PROD:
        ...
        break;
      case IGRAPH_ATTRIBUTE_COMBINE_MIN:
        IGRAPH_ERROR("Cannot find minimum of strings", IGRAPH_EATTRCOMBINE);
        break;
      case IGRAPH_ATTRIBUTE_COMBINE_MAX:
        IGRAPH_ERROR("Cannot find maximum of strings", IGRAPH_EATTRCOMBINE);
        break;
      case IGRAPH_ATTRIBUTE_COMBINE_MEAN:
        IGRAPH_ERROR("Cannot calculate mean of strings", IGRAPH_EATTRCOMBINE);
        break;
      case IGRAPH_ATTRIBUTE_COMBINE_MEDIAN:
        IGRAPH_ERROR("Cannot calculate median of strings", IGRAPH_EATTRCOMBINE);
        break;
      case IGRAPH_ATTRIBUTE_COMBINE_RANDOM:
...
/* void igraph_i_cattribute_delete_edges(igraph_t *graph, const igraph_vector_t
 * *idx) { */
...
int igraph_i_cattribute_permute_edges(const igraph_t *graph, igraph_t *newgraph,
                                      const igraph_vector_t *idx) {
...
int igraph_i_cattribute_combine_edges(
    const igraph_t *graph, igraph_t *newgraph,
    const igraph_vector_ptr_t *merges,
    const igraph_attribute_combination_t *comb) {
 ...
 */
int igraph_cattribute_list(const igraph_t *graph, igraph_strvector_t *gnames,
 ...
 * \param graph The graph.
 * \param name Name of the attribute.
 * \param sv String vector, the new attribute values. The length of this vector
 * must match the number of vertices. \return Error code.
 *
 ...
 * \param name Name of the attribute.
 * \param sv String vector, the new attribute values. The length of this vector
 * must match the number of edges. \return Error code.
 *
