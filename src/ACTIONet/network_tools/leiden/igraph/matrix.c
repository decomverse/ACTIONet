...
int igraph_matrix_complex_fprint(const igraph_matrix_complex_t *m, FILE *file) {
...
int igraph_matrix_complex_realimag(const igraph_matrix_complex_t *v,
  ...
  IGRAPH_CHECK(igraph_matrix_resize(imag, nrow, ncol));
  IGRAPH_CHECK(
      igraph_vector_complex_realimag(&v->data, &real->data, &imag->data));
  return 0;
}
...
int igraph_matrix_complex_create(igraph_matrix_complex_t *v,
  ...
  IGRAPH_CHECK(
      igraph_vector_complex_create(&v->data, &real->data, &imag->data));
  return 0;
}
...
int igraph_matrix_complex_create_polar(igraph_matrix_complex_t *v,
  ...
  IGRAPH_CHECK(
      igraph_vector_complex_create_polar(&v->data, &r->data, &theta->data));
  return 0;
}
