...
SurpriseVertexPartition::create(Graph *graph,
...
#ifdef DEBUG
  cerr << "virtual double SurpriseVertexPartition::diff_move(" << v << ", "
       << new_comm << ")" << endl;
#endif
...
#endif
    double delta_nc2 =
        2.0 * nsize * (ptrdiff_t)(n_new - n_old + nsize) / normalise;
...
#ifdef DEBUG
  cerr << "exit double SurpriseVertexPartition::diff_move(" << v << ", "
       << new_comm << ")" << endl;
