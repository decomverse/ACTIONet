...
/*
		result = optimize_layout_largevis(head_vec, tail_vec, positive_head, positive_tail, n_epochs,
			nV, epochs_per_sample, GAMMA, LEARNING_RATE, NEGATIVE_SAMPLE_RATE);	
*/

		result = optimize_layout_tumap(head_vec, tail_vec, positive_head, positive_tail, n_epochs,
			nV, epochs_per_sample, LEARNING_RATE, NEGATIVE_SAMPLE_RATE);	
