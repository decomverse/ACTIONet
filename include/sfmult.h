...
arma::sp_mat &ssmult_transpose // returns C = A' or A.'    (TO DO) rename
    (
        // --- inputs, not modified:
        const arma::sp_mat &A,
...
arma::mat &sfmult_AN_XN_YN // returns y = A*x
    (
        // --- inputs, not modified:
        const arma::sp_mat &A,
        const arma::mat &X,
...
arma::mat &sfmult_AN_XN_YT // returns y = (A*x)'
    (
        // --- inputs, not modified:
        const arma::sp_mat &A,
        const arma::mat &X,
...
arma::mat &sfmult_AN_XT_YN // returns y = A*x'
    (
        // --- inputs, not modified:
        const arma::sp_mat &A,
        const arma::mat &X,
...
arma::mat &sfmult_AN_XT_YT // returns y = (A*x')'
    (
        // --- inputs, not modified:
        const arma::sp_mat &A,
        const arma::mat &X,
...
arma::mat &sfmult_AT_XN_YN // returns y = A'*x
    (
        // --- inputs, not modified:
        const arma::sp_mat &A,
        const arma::mat &X,
...
arma::mat &sfmult_AT_XN_YT // returns y = (A'*x)'
    (
        // --- inputs, not modified:
        const arma::sp_mat &A,
        const arma::mat &X,
...
arma::mat &sfmult_AT_XT_YN // returns y = A'*x'
    (
        // --- inputs, not modified:
        const arma::sp_mat &A,
        const arma::mat &X,
...
arma::mat &sfmult_AT_XT_YT // returns y = (A'*x')'
    (
        // --- inputs, not modified:
        const arma::sp_mat &A,
        const arma::mat &X,
...
arma::mat &sfmult_yalloc // allocate and return result y
    (
        // --- inputs, not modified:
        Int m,
        Int n,
...
arma::mat &sfmult_yzero // set y to zero
    (
