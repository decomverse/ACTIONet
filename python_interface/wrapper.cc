...
py::dict run_ACTION(arma::Mat<npdouble>& S_r, int k_min = 2, int k_max = 30, int thread_no = 0, int max_it = 50, double min_delta = 1e-16) {
...
// }
py::dict unify_archetypes(mat &S_r, mat &C_stacked, mat &H_stacked, double sensitivity = 1.0, int normalization_type = 1, double edge_threshold = 0.5) {
...
PYBIND11_MODULE(_ACTIONet, m) {
	...
	m.def(
		"unify_archetypes",
		py::overload_cast<arma::Mat<npdouble>&, arma::Mat<npdouble>&, arma::Mat<npdouble>&, double, int, double>(&unify_archetypes),
		"Identifies and aggregates redundant archetypes into equivalent classes",
		py::arg("S_r"), py::arg("C_stacked"), py::arg("H_stacked"), py::arg("sensitivity")=1.0, py::arg("normalization_type")=1, py::arg("edge_threshold")=0.5
	);
