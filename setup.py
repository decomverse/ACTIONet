...
ACTIONet_module = Extension(
    ...
    include_dirs=blas_opt['include_dirs'] + ['include', 'include/arma','include/ACTIONet', 'include/ACTIONet/hnsw', 'include/ACTIONet/leiden', 'include/ACTIONet/leiden/igraph','include/ACTIONet/HDBSCAN', 'include/ACTIONet/s_gd2', 'include/ACTIONet/uwot', get_pybind_include(), get_pybind_include(user=True)],
	library_dirs = blas_opt['library_dirs'],
	libraries = blas_opt['libraries'],
    language='c++'
)
